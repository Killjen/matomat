        ...
        <!--<div id="container">-
              ...
              <<div id="wrapper">-->
                <div id="content">
                  ...
                  <table id="Header">
                    ...
                    //username to search:
                    $susername = filter_input(INPUT_POST, 'username', FILTER_SANITIZE_STRING);
                ...
                <!-- ####################### User Table ###### -->      
                    ...
                    if (empty($susername)){
                        ...
                        $sql = "SELECT * from users WHERE Username LIKE \"$susername%\"";
                    }
                    ...
                    if ($result->num_rows > 0){
                        ...
                        while($row = $result->fetch_row()){
                            echo "<tr> ";
                            for($x=0; $x < count($row); $x++){
                                //\"if(event.keyCode==13) {changeTable('Users',$i,\"$row[0]\",$x);}\"
                                //echo "<td contenteditable='true' onChange='window.alert(\"Test!\")'> " . $row[$x] . "</td>";
            ...
            <div id="navigation">
                ...
                <ul>
                    ...
                    <li><p><a href="">Register (dead!)</a></p></li>
                </ul>
                <hr \>
